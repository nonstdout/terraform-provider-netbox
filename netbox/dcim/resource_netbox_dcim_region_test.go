...
func TestAccNetboxDcimRegionMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxDcimRegionConfig(nameSuffix, false, false, 0),
...
func TestAccNetboxDcimRegionFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxDcimRegionConfig(nameSuffix, true, true, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxDcimRegion),
				),
			},
...
func TestAccNetboxDcimRegionMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxDcimRegionConfig(nameSuffix, false, false, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxDcimRegion),
				),
			},
			...
			{
				Config: testAccCheckNetboxDcimRegionConfig(nameSuffix, false, true, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxDcimRegion),
				),
			},
...
func testAccCheckNetboxDcimRegionConfig(nameSuffix string, resourceFull, extraResources bool, asn int64) string {
	template := `
